...
const FIXTURE: RadarResponse = {
  parent: {
    ...
    mission:
      "Invests in the communities it serves through youth development, education access, food security, and leadership programs delivered alongside local nonprofit partners.",
    programs: ["Youth development", "Education access", "Food security", "Leadership development"],
    populations: ["Youth", "Underserved communities"],
    location: { city: "Atlanta", state: "GA", country: "US" },
    grants: {
      status: "ok",
      qualifiedCount: 3,
      qualifiedFundingTotal: 12_500_000,
      rawCount: 10,
      cappedAtLimit: false,
      top: [
        {
          guid: "fixture-parent-1",
          programName: "Community Economic Development Projects",
          agency: "U.S. Department of Health and Human Services",
          fundingDisplay: "$800,000",
          closingDateDisplay: "Apr 30, 2026",
          closingInfo: null,
          difficulty: "Might Need Help",
          competitive: true,
          url: "https://grantguru.com/grants/fixture-parent-1",
          matchScore: 72,
          matchQuality: "good",
        },
        {
          guid: "fixture-parent-2",
          programName: "Full-Service Community Schools Program",
          agency: "U.S. Department of Education",
          fundingDisplay: "$500,000",
          closingDateDisplay: "May 15, 2026",
          closingInfo: null,
          difficulty: "Doable",
          competitive: false,
          url: "https://grantguru.com/grants/fixture-parent-2",
          matchScore: 66,
          matchQuality: "good",
        },
      ],
